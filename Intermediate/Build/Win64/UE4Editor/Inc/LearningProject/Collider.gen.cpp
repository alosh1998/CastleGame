...
#include "LearningProject/Collider.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_ACollider_NoRegister();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_ACollider();
	ENGINE_API UClass* Z_Construct_UClass_APawn();
	UPackage* Z_Construct_UPackage__Script_LearningProject();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_UColliderMovementComponent_NoRegister();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACollider_Statics::NewProp_OurMovementComponent_MetaData[] = {
		{ "Category", "Mesh" },
		{ "Comment", "// this variable is a reference to the movement class we have created becasue pawn doesnt have default movement\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Collider.h" },
		{ "ToolTip", "this variable is a reference to the movement class we have created becasue pawn doesnt have default movement" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACollider_Statics::NewProp_SpringArm_MetaData[] = {
		{ "Category", "Mesh" },
		{ "Comment", "// this helps controll camera motion\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Collider.h" },
		{ "ToolTip", "this helps controll camera motion" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACollider_Statics::NewProp_SphereComponent_MetaData[] = {
		{ "Category", "Mesh" },
		{ "Comment", "// define shpere for the collision and the physics\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Collider.h" },
		{ "ToolTip", "define shpere for the collision and the physics" },
	};
#endif
	...
	IMPLEMENT_CLASS(ACollider, 3980181072);
	template<> LEARNINGPROJECT_API UClass* StaticClass<ACollider>()
	{
		return ACollider::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACollider(Z_Construct_UClass_ACollider, &ACollider::StaticClass, TEXT("/Script/LearningProject"), TEXT("ACollider"), false, nullptr, nullptr, nullptr);
