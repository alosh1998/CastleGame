...
// Cross Module References
	LEARNINGPROJECT_API UEnum* Z_Construct_UEnum_LearningProject_EEnemyMovmentStatus();
	UPackage* Z_Construct_UPackage__Script_LearningProject();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AEnemy_NoRegister();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AEnemy();
...
// End Cross Module References
	static UEnum* EEnemyMovmentStatus_StaticEnum()
	{
		static UEnum* Singleton = nullptr;
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_LearningProject_EEnemyMovmentStatus, Z_Construct_UPackage__Script_LearningProject(), TEXT("EEnemyMovmentStatus"));
		}
		return Singleton;
	}
	template<> LEARNINGPROJECT_API UEnum* StaticEnum<EEnemyMovmentStatus>()
	{
		return EEnemyMovmentStatus_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EEnemyMovmentStatus(EEnemyMovmentStatus_StaticEnum, TEXT("/Script/LearningProject"), TEXT("EEnemyMovmentStatus"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_LearningProject_EEnemyMovmentStatus_Hash() { return 2014967576U; }
	UEnum* Z_Construct_UEnum_LearningProject_EEnemyMovmentStatus()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_LearningProject();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EEnemyMovmentStatus"), 0, Get_Z_Construct_UEnum_LearningProject_EEnemyMovmentStatus_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "EEnemyMovmentStatus::EMS_Idle", (int64)EEnemyMovmentStatus::EMS_Idle },
				{ "EEnemyMovmentStatus::EMS_MoveToTarget", (int64)EEnemyMovmentStatus::EMS_MoveToTarget },
				{ "EEnemyMovmentStatus::EMS_Attacking", (int64)EEnemyMovmentStatus::EMS_Attacking },
				{ "EEnemyMovmentStatus::EMS_Dead", (int64)EEnemyMovmentStatus::EMS_Dead },
				{ "EEnemyMovmentStatus::EMS_MAX", (int64)EEnemyMovmentStatus::EMS_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "Comment", "// enum for enemy movement\n" },
				{ "EMS_Attacking.DisplayName", "Attacking" },
				{ "EMS_Attacking.Name", "EEnemyMovmentStatus::EMS_Attacking" },
				{ "EMS_Dead.DisplayName", "Dead" },
				{ "EMS_Dead.Name", "EEnemyMovmentStatus::EMS_Dead" },
				{ "EMS_Idle.DisplayName", "Idle" },
				{ "EMS_Idle.Name", "EEnemyMovmentStatus::EMS_Idle" },
				{ "EMS_MAX.DisplayName", "DefaultMAX" },
				{ "EMS_MAX.Name", "EEnemyMovmentStatus::EMS_MAX" },
				{ "EMS_MoveToTarget.DisplayName", "MoveToTarget" },
				{ "EMS_MoveToTarget.Name", "EEnemyMovmentStatus::EMS_MoveToTarget" },
				{ "ModuleRelativePath", "Enemy.h" },
				{ "ToolTip", "enum for enemy movement" },
			};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemy_CombatOnOverlapBegin_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// overlap for when the weapon hits enemy\n" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "overlap for when the weapon hits enemy" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AEnemy_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AEnemy_Attackend, "Attackend" }, // 3907549832
		{ &Z_Construct_UFunction_AEnemy_CombatOnOverlapBegin, "CombatOnOverlapBegin" }, // 2324397815
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_HitParticles_MetaData[] = {
		{ "Category", "AI" },
		{ "Comment", "// what kind of particles the enemy will play when hit, eg blood squirting\n" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "what kind of particles the enemy will play when hit, eg blood squirting" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_Health_MetaData[] = {
		{ "Category", "AI" },
		{ "Comment", "// enemy health property\n" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "enemy health property" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_CombatSphere_MetaData[] = {
		{ "Category", "AI" },
		{ "Comment", "// sphere is to wrapp the AI, and if player overlap with it the AI will start attacking\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "sphere is to wrapp the AI, and if player overlap with it the AI will start attacking" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_AgroSphere_MetaData[] = {
		{ "Category", "AI" },
		{ "Comment", "// sphere is to wrapp the AI, and if player overlap with it the AI will start chasing\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "sphere is to wrapp the AI, and if player overlap with it the AI will start chasing" },
	};
#endif
	...
	IMPLEMENT_CLASS(AEnemy, 2415931864);
	template<> LEARNINGPROJECT_API UClass* StaticClass<AEnemy>()
	{
		return AEnemy::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEnemy(Z_Construct_UClass_AEnemy, &AEnemy::StaticClass, TEXT("/Script/LearningProject"), TEXT("AEnemy"), false, nullptr, nullptr, nullptr);
