...
#include "LearningProject/FloatingPlatform.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AFloatingPlatform_NoRegister();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AFloatingPlatform();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_EndPoint_MetaData[] = {
		...
		{ "Comment", "// meta = (MakeEditWidget = \"true\"): to add visualization widget in the editor\n" },
		{ "MakeEditWidget", "true" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
		{ "ToolTip", "meta = (MakeEditWidget = \"true\"): to add visualization widget in the editor" },
	};
#endif
	...
	IMPLEMENT_CLASS(AFloatingPlatform, 3766140547);
	template<> LEARNINGPROJECT_API UClass* StaticClass<AFloatingPlatform>()
	{
		return AFloatingPlatform::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFloatingPlatform(Z_Construct_UClass_AFloatingPlatform, &AFloatingPlatform::StaticClass, TEXT("/Script/LearningProject"), TEXT("AFloatingPlatform"), false, nullptr, nullptr, nullptr);
