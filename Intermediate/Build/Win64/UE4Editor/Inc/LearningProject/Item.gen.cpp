...
#include "LearningProject/Item.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_OverlapParticles_MetaData[] = {
		...
		{ "Comment", "// UParticleSystem is declared different to the previous one\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "UParticleSystem is declared different to the previous one" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_IdleParticlesComponent_MetaData[] = {
		{ "Category", "Item | Particles" },
		{ "Comment", "// class UParticleSystemComponent will only be decalred using CreateDefaultSubobject\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "class UParticleSystemComponent will only be decalred using CreateDefaultSubobject" },
	};
#endif
	...
	IMPLEMENT_CLASS(AItem, 3364700329);
	template<> LEARNINGPROJECT_API UClass* StaticClass<AItem>()
	{
		return AItem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AItem(Z_Construct_UClass_AItem, &AItem::StaticClass, TEXT("/Script/LearningProject"), TEXT("AItem"), false, nullptr, nullptr, nullptr);
