...
#include "LearningProject/FloorSwitch.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AFloorSwitch_NoRegister();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AFloorSwitch();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFloorSwitch_OnOverlapBegin_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// when binding a function to OnComponentBeginOverlap, it must be UFUNCTION() \n" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "when binding a function to OnComponentBeginOverlap, it must be UFUNCTION()" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFloorSwitch_RaiseDoor_Statics::Function_MetaDataParams[] = {
		{ "Category", "Floor Switch" },
		{ "Comment", "// BlueprintImplementableEvent: means that you dont have to implement the functionality of the function in C++...\n// ...it can be done in blueprint\n" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "BlueprintImplementableEvent: means that you dont have to implement the functionality of the function in C++...\n...it can be done in blueprint" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFloorSwitch_UpdateDoorLocation_Statics::Function_MetaDataParams[] = {
		{ "Category", "Floor Switch" },
		{ "Comment", "// BlueprintCallable: means that it can be called from blueprint but the implementation will be in C++\n" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "BlueprintCallable: means that it can be called from blueprint but the implementation will be in C++" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFloorSwitch_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AFloorSwitch_OnOverlapBegin, "OnOverlapBegin" }, // 2434224123
		{ &Z_Construct_UFunction_AFloorSwitch_OnOverlapEnd, "OnOverlapEnd" }, // 1862783755
		{ &Z_Construct_UFunction_AFloorSwitch_RaiseDoor, "RaiseDoor" }, // 2277793072
		{ &Z_Construct_UFunction_AFloorSwitch_RaiseFloorSwitch, "RaiseFloorSwitch" }, // 2533339380
		{ &Z_Construct_UFunction_AFloorSwitch_UpdateDoorLocation, "UpdateDoorLocation" }, // 1299422780
		{ &Z_Construct_UFunction_AFloorSwitch_UpdateFloorSwitchLocation, "UpdateFloorSwitchLocation" }, // 3222616096
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_TriggerBox_MetaData[] = {
		{ "Category", "Floor Switch" },
		{ "Comment", "/** Overlap volume for the functionality to be triggered*/" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "Overlap volume for the functionality to be triggered" },
	};
#endif
	...
	IMPLEMENT_CLASS(AFloorSwitch, 3650763621);
	template<> LEARNINGPROJECT_API UClass* StaticClass<AFloorSwitch>()
	{
		return AFloorSwitch::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFloorSwitch(Z_Construct_UClass_AFloorSwitch, &AFloorSwitch::StaticClass, TEXT("/Script/LearningProject"), TEXT("AFloorSwitch"), false, nullptr, nullptr, nullptr);
