...
#include "LearningProject/Weapon.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	LEARNINGPROJECT_API UEnum* Z_Construct_UEnum_LearningProject_EWeaponState();
	UPackage* Z_Construct_UPackage__Script_LearningProject();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AWeapon_NoRegister();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AWeapon();
	LEARNINGPROJECT_API UClass* Z_Construct_UClass_AItem();
...
// End Cross Module References
	static UEnum* EWeaponState_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_LearningProject_EWeaponState, Z_Construct_UPackage__Script_LearningProject(), TEXT("EWeaponState"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EWeaponState(EWeaponState_StaticEnum, TEXT("/Script/LearningProject"), TEXT("EWeaponState"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_LearningProject_EWeaponState_Hash() { return 3881446933U; }
	UEnum* Z_Construct_UEnum_LearningProject_EWeaponState()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_LearningProject();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EWeaponState"), 0, Get_Z_Construct_UEnum_LearningProject_EWeaponState_Hash(), false);
#else
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AWeapon_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AWeapon_CombatOnOverlapBegin, "CombatOnOverlapBegin" }, // 78187523
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeapon_Statics::NewProp_SkeletalMesh_MetaData[] = {
		...
		{ "Comment", "// use skeletal because weapons aren't meshs,\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Weapon.h" },
		{ "ToolTip", "use skeletal because weapons aren't meshs," },
	};
#endif
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AWeapon_Statics::NewProp_WeaponState = { "WeaponState", nullptr, (EPropertyFlags)0x0010000000020005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AWeapon, WeaponState), Z_Construct_UEnum_LearningProject_EWeaponState, METADATA_PARAMS(Z_Construct_UClass_AWeapon_Statics::NewProp_WeaponState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AWeapon_Statics::NewProp_WeaponState_MetaData)) };
	...
	IMPLEMENT_CLASS(AWeapon, 3918000661);
	template<> LEARNINGPROJECT_API UClass* StaticClass<AWeapon>()
	{
		return AWeapon::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AWeapon(Z_Construct_UClass_AWeapon, &AWeapon::StaticClass, TEXT("/Script/LearningProject"), TEXT("AWeapon"), false, nullptr, nullptr, nullptr);
